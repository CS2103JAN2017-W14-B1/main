                ...
                <VBox alignment="CENTER_LEFT" minHeight="20.0" GridPane.columnIndex="0">
                    ...
                    <children>
                        <HBox spacing="5" alignment="CENTER_LEFT">
                            <children>
                                <HBox>
                                    <Label fx:id="firstDate" prefWidth="80.0" styleClass="cell_small_label"/>
                                    <Label fx:id="connector" prefWidth="3.0" styleClass="cell_small_label"/>
                                    <Label fx:id="secondDate" prefWidth="90.0" styleClass="cell_small_label"/>
